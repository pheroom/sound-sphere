...
import cls from './EditUserProfileForm.module.css';
...
export const EditUserProfileForm = memo(({ className }: EditUserProfileFormProps) => {
    ...
    return (
        <div className={classNames(cls.EditUserProfileForm, {}, [className])}>
