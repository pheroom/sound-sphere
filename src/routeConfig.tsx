...
export const routeConfig: appRouteType[] = [
    ...
    { path: AppRoutes.ARTISTS, element: <ArtistsListPage />, targets: [TargetTypes.USER] },
    { path: AppRoutes.ARTISTS_PROFILE, element: <ArtistsProfilePage />, targets: [TargetTypes.USER] },
